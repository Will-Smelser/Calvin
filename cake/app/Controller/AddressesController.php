 ...
 */
	public function add() {
		...
		$companies = $this->Address->Company->find('list');
		$stateCodes = $this->Address->StateCode->find('list');
		$countryCodes = $this->Address->CountryCode->find('list');
		$this->set(compact('companies', 'stateCodes', 'countryCodes'));
	}
